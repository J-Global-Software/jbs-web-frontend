...
export default function BookingCalendar({ selectedDate, onDateSelect, selectedSlot, onSlotSelect, onContinue, showContinueButton = false, continueButtonText, userTimezone, apiEndpoint = "/api/free-coaching/available-slots/", maxMonthsAhead = 6, disabled = false }: BookingCalendarProps) {
