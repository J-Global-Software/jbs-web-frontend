		...
		<div id="why-us" className="relative overflow-hidden">
			...
			<section className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-15 pt-15 text-center">
				<div className="flex flex-col items-center">
					...
					<h2 className="text-3xl max-w-5xl md:text-4xl font-extrabold tracking-tight text-gray-900 mb-8 leading-tight">{parse(mainTitle!, options)}</h2>
				</div>

				{/* Description - Using whitespace-pre-line to handle \n from CMS */}
				<p className="text-xl text-gray-600 leading-relaxed max-w-3xl mx-auto whitespace-pre-line">{descriptionText}</p>
			</section>
			...
			<section className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-10">
				<div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
					{data?.reasons?.map((reason, i) => {
						...
						return (
							<div key={i} className="group bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-md hover:border-[#215ca5]/20 transition-all duration-300 flex flex-col p-7">
								{/* Icon Container */}
